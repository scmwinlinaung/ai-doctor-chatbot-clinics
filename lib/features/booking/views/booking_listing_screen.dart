...
//               _buildInfoRow(
//                   'Confirmed Date',
//                   DateUtil.formatStringToDateOnly(booking.confirmedDate!) +
//                       booking.time!,
//                   theme),
//             _buildInfoRow(
...
//               _buildInfoRow('Created', booking.createdAt!, theme),
//             const SizedBox(height: 16),
...
//               ),
//             ]
//             // CONFIRMED BOOKING: Display a confirmation message and Book Again button
...
//     // For booking again, we'll create a new booking using the same clinic
//     // and show the confirmation modal to select doctor, date, and time
//     showModalBottomSheet(
//       context: context,
//       isScrollControlled: true,
//       backgroundColor: Colors.transparent,
...
// // Book Again Modal - Similar to Confirm Booking Modal but for creating a new booking
// class _BookAgainModal extends StatefulWidget {
//   final ClinicBookingModel originalBooking;
//   final String clinicId;
...
//     // Pre-fill with previous booking details if available
//     if (widget.originalBooking.doctorName != null) {
//       // We'll need to find the doctor ID by name when the clinic data loads
//     }
//   }
...
//       // Create a new booking by calling the confirmBooking API
//       // We'll use the original booking ID to create a new one
//       context.read<BookingCubit>().confirmBooking(
//             widget.originalBooking.id!,
//             _selectedDoctorId!,
//             _dateController.text,
//             _timeController.text,
//           );
...
//               Text(
//                 'Create a new appointment for ${widget.originalBooking.user?.username ?? 'Patient'}',
//                 style: theme.textTheme.bodyMedium?.copyWith(
