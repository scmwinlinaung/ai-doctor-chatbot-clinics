...
abstract class $RegionModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: '_id') String id, String name, String city});
}
...
class _$RegionModelImpl implements _RegionModel {
  const _$RegionModelImpl(
      {@JsonKey(name: '_id') this.id = "", this.name = "", this.city = ""});
  ...
  @override
  String toString() {
    return 'RegionModel(id: $id, name: $name, city: $city)';
  }
...
abstract class _RegionModel implements RegionModel {
  const factory _RegionModel(
      ...
      final String name,
      final String city}) = _$RegionModelImpl;
