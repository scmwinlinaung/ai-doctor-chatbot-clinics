    ...
    try {
      ...
      for (var booking in bookings) {
        ...
        sheetObject.appendRow([
          ...
          TextCellValue(booking.city ?? 'N/A'),
          TextCellValue(booking.region ?? 'N/A'),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _buildDetailItem(Icons.location_city_outlined, booking.city ?? 'N/A'),
                        const SizedBox(width: 24),
                        _buildDetailItem(Icons.map_outlined, booking.region ?? 'N/A'),
                      ],
                    ),
